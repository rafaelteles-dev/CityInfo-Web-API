...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<PointOfInterestDto>> GetPointsOfInterest(int cityId)
        {
            ...
            {
                _logger.LogCritical($"Exception while getting poiints of interest for city with id {cityId}", ex);
        ...
        [HttpPost]
        public ActionResult<PointOfInterestDto> CreatePointsOfInterest(int cityId, PointsOfInterestForCreationDto pointOfInterest)
        {
