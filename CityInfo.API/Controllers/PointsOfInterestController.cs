...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PointOfInterestDto>>> GetPointsOfInterest(int cityId)
        {
            ...
            {
                _logger.LogInformation($"City of id {cityId} was not found when accessing points of interest.");
                return NotFound();
            }
        ...
        [HttpPost]
        public async Task<ActionResult<PointOfInterestDto>> CreatePointsOfInterest(int cityId, PointsOfInterestForCreationDto pointOfInterest)
        {
